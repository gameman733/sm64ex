...
Recent changes in Nightly have moved the save and configuration file path to `%HOMEPATH%\AppData\Roaming\sm64AP` on Windows and `$HOME/.local/share/sm64AP` on Linux. This behaviour can be changed with the `--savepath` CLI option.
